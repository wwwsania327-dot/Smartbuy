              ...
              return (
                <li key={item.name} className="relative z-10 flex-1">
                  ...
                  >
                    <m.div
                      whileTap={{ scale: 0.85 }}
                      className={`relative p-2 rounded-xl transition-colors duration-300 ${isActive ? 'text-emerald-500' : 'text-gray-400 dark:text-gray-500'}`}
                    >
                      {isActive && (
                        <m.div
                    ...
                    <m.span 
                      ...
                      className={`text-xs font-bold mt-1 tracking-wider transition-colors duration-300 ${isActive ? 'text-emerald-600 dark:text-emerald-400' : 'text-gray-400 dark:text-gray-500'}`}
                    >
                      {item.name}
                    </m.span>
                  </Link>
